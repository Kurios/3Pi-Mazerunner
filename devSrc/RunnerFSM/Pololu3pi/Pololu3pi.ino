/*
 * Pololu 3pi Hardware Interface
 * All Arduino glue to talk to the 3pi robot
 */
...
const char ImARamblingWreckFromGeorgiaTech[] PROGMEM = "T240 MS gf8e-e-8e-f8gg8g";
const char HellOfAnEngineer[] PROGMEM = "T240 MS g8f8e-8f8g8f8e-d8 ML e-.e-";
//const char AHellOfAHellOfA[] PROGMEM   = "T240 MS f8g8g8g8g8g8a8b-8b-8b-8b-8b-8b-8b-8f8f8ff8 ML f.f";
...
void initialize3pi()
{
  ...
  OrangutanBuzzer::playFromProgramSpace(ImARamblingWreckFromGeorgiaTech);
